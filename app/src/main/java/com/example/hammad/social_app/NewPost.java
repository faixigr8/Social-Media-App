package com.example.hammad.social_app;
...
public class NewPost extends AppCompatActivity {
    ...
    public void Status_Post_BTN_CLICK(View view){
        ...
        if(Status_Description.isEmpty())
            ...
            SimpleDateFormat NowDate = new SimpleDateFormat("dd-MMMM-yyyy");
            ...
            UserReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        PostReference.child(currentUID + RandomNumber).updateChildren(user_POST)
